...
public class Data {
    ...
    public static Info sources = new Info(
            ...
            +
            "\nJuno: https://www.nasa.gov/mission_pages/juno/main/index.html https://www.nasa.gov/mission_pages/juno/overview/index.html"
            +
            ...
            +
            "\nList of Early Space Achievements (Project Mercury): http://ic.galegroup.com/ic/uhic/ReferenceDetailsPage/ReferenceDetailsWindow?disableHighlighting=false&displayGroupName=Reference&currPage=&scanId=&query=&source=&prodId=UHIC&search_within_results=&p=UHIC%3AWHIC&mode=view&catId=&u=colc95696&limiter=&display-query=&displayGroups=&contentModules=&action=e&sortBy=&documentId=GALE%7CCX3468302505&windowstate=normal&activityType=&failOverType=&commentary="
            +
            "\nTimeline of Space Travel: http://www.greatachievements.org/?id=3642"
            +
            "\nPrimary of the First Satellite: http://ic.galegroup.com/ic/uhic/PrimarySourcesDetailsPage/PrimarySourcesDetailsWindow?disableHighlighting=false&displayGroupName=PrimarySources&currPage=&scanId=&query=&source=&prodId=UHIC&search_within_results=&p=UHIC%3AWHIC&mode=view&catId=&u=colc95696&limiter=&display-query=&displayGroups=&contentModules=&action=e&sortBy=&documentId=GALE%7CCX3441400082&windowstate=normal&activityType=&failOverType=&commentary="
            +
            "\nPrimary US space shuttles: http://ic.galegroup.com/ic/uhic/PrimarySourcesDetailsPage/PrimarySourcesDetailsWindow?disableHighlighting=false&displayGroupName=PrimarySources&currPage=&scanId=&query=&source=&prodId=UHIC&search_within_results=&p=UHIC%3AWHIC&mode=view&catId=&u=colc95696&limiter=&display-query=&displayGroups=&contentModules=&action=e&sortBy=&documentId=GALE%7CCX3441400088&windowstate=normal&activityType=&failOverType=&commentary="
            +
            "\nFuture of Interstellar Travel: http://www.space.com/13165-interstellar-travel-starship-destinations.html"
        );
}
